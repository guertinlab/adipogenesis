...
[github raw](https://raw.githubusercontent.com/guertinlab/adipogenesis/master/Bao_code_chunks/1.1_alignment_make_slurm.sh)
...
[github raw](https://raw.githubusercontent.com/guertinlab/adipogenesis/master/Bao_code_chunks/1.2_bam_to_bigwig_make_slurm.sh)
```{r eval=FALSE}
...
[github raw](https://raw.githubusercontent.com/guertinlab/adipogenesis/master/Bao_code_chunks/3.2_meme_motif_enrichment_make_slurm.sh)
```{r eval=FALSE}
...
[github raw](https://raw.githubusercontent.com/guertinlab/adipogenesis/master/Bao_code_chunks/5.1_SP_KLF_split_generate_composites.slurm)
```{r eval=FALSE}
cd /scratch/bhn9by/ATAC/
...
[github raw](https://raw.githubusercontent.com/guertinlab/adipogenesis/master/Bao_code_chunks/5.2_fimo_composite_make_slurm.sh)
```{r eval=FALSE}
...
[github raw](https://raw.githubusercontent.com/guertinlab/adipogenesis/master/Bao_code_chunks/5.2_fimo_composite_simplified.sh)
```{r eval=FALSE}
#!/bin/bash
#SBATCH -n 1
#SBATCH -t 96:00:00
...
[github raw](https://raw.githubusercontent.com/guertinlab/adipogenesis/master/Bao_code_chunks/5.3_prep_main_figure_1.sh)
```{r eval=FALSE}
#!/bin/bash
...
[github raw](https://raw.githubusercontent.com/guertinlab/adipogenesis/master/Bao_code_chunks/5.4_SP_KLF_split_processing.sh)
```{r eval=FALSE}
...
[github raw](https://raw.githubusercontent.com/guertinlab/adipogenesis/master/Bao_code_chunks/5.5_extract_up_down_SP_KLF.sh)
```{r eval=FALSE}
...
[github raw](https://raw.githubusercontent.com/guertinlab/adipogenesis/master/Bao_code_chunks/F.1.2_bed_to_bigWig.sh)
```{r eval=FALSE}
...
[github raw](https://raw.githubusercontent.com/guertinlab/adipogenesis/master/Bao_code_chunks/F.1.3_plot.motif.enrichment.R)
```{r eval=FALSE}
library(lattice)
library(bigWig)
...
Generate plots for supplemental families (plots not shown due to repetitiveness)

[github raw](https://raw.githubusercontent.com/guertinlab/adipogenesis/master/Bao_code_chunks/F.1.4_supplemental_figure_1.sh)
```{r eval=FALSE}
cd /scratch/bhn9by/ATAC/fimo_composites
