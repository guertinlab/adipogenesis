...
[overlaps_keepadjacent.csv](https://raw.githubusercontent.com/guertinlab/adipogenesis/master/Bao_code_chunks_PRO/misc_scripts/overlaps_keepadjacent.csv),
[duplicate_remove.csv](https://raw.githubusercontent.com/guertinlab/adipogenesis/master/Bao_code_chunks_PRO/misc_scripts/duplicate_remove.csv),
[duplicate_keepadjacent.csv](https://raw.githubusercontent.com/guertinlab/adipogenesis/master/Bao_code_chunks_PRO/misc_scripts/duplicate_keepadjacent.csv):
...
# PRO Clustering
Cluster dynamic peaks using degPatterns. Rscript should be run as slurm job due to large
memory requirement.

# PRO Postclustering
The following Rscript visualizes the pTA clustering with plots of clusters, dendrogram, etc.

# Generating comprehensive PRO dataframe
Rerun analysis to generate final PRO dataframe containing all relevant features

[github raw](https://raw.githubusercontent.com/guertinlab/adipogenesis/master/Pipeline_PRO/3.4_create.final.pro.all.df.R)
```{r eval=FALSE}
library(DESeq2)
