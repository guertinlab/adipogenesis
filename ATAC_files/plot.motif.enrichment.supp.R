...
dir = '/scratch/abd3x/ATAC/fimo_composites/supp_figure_beds/'
setwd(dir)
...
load('/scratch/abd3x/ATAC/fimo_composites/supp_figure_beds/supp.fimo.scores.atac.Rdata')
...
not.different = read.table('/scratch/abd3x/ATAC/nondynamic_peaks.bed')
