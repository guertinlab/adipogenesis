...
save(fimo.scores.atac, file = '/scratch/abd3x/ATAC/fimo_composites/supp_figure_beds/supp.fimo.scores.atac.Rdata')
...
#now add SP and KLF
sp = read.table('/scratch/abd3x/ATAC/SP_KLF_split/output_sp1.txt', stringsAsFactors=FALSE, sep = '\t', header = TRUE)[,c(3,10)]
...
klf = read.table('/scratch/abd3x/ATAC/SP_KLF_split/output_klf.txt', stringsAsFactors=FALSE, sep = '\t', header = TRUE)[,c(3,10)]
