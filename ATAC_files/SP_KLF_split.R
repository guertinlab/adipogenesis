...
write.table(sp.bed,file='/scratch/abd3x/ATAC/fimo_composites/main_figure_beds/SP_unsorted.bed',quote=F,sep='\t',row.names=F,col.names=F)

write.table(klf.bed,file='/scratch/abd3x/ATAC/fimo_composites/main_figure_beds/KLF_unsorted.bed',quote=F,sep='\t',row.names=F,col.names=F)
